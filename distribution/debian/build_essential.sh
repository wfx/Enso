...
libffi6-dbg libfontconfig1-dev libfreetype6-dev libfribidi-dev libgbm-dev libgif-dev libgles2-mesa-dev \
...
libxkbcommon-dev libxrandr-dev libxrender-dev libxss-dev libxtst-dev mtdev-tools pkg-config python-dbus \
python-dev python-distutils-extra python-xdg ragel valgrind wmctrl xserver-xephyr
