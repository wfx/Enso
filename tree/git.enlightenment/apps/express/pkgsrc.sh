...
# SETTING ============================================ #
pkg_source[description]="IRC client with enhanced media capabilities" # Short description (optional)
pkg_source[url]="https://git.enlightenment.org/apps/express.git" # full url (address/filename.extension)
