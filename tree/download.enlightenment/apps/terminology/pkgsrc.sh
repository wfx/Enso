...
# SETTING ============================================ #
pkg_source[description]="Terminology is a terminal emulator for Linux/BSD/UNIX etc"       # Short description (optional)
pkg_source[url]="http://download.enlightenment.org/rel/apps/terminology/terminology-0.9.1.tar.gz" # full url (address/filename.extension)
