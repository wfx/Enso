...
# SETTING ============================================ #
pkg_source[description]="EFL Edje Theme Editor"       # Short description (optional)
pkg_source[url]="http://download.enlightenment.org/rel/apps/eflete/eflete-0.7.0.tar.gz" # full url (address/filename.extension)
