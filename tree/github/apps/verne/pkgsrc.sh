...
# SETTING ============================================ #
pkg_source[description]="A small efl based filemanager"       # Short description (optional)
pkg_source[url]="https://github.com/marcelhollerbach/verne.git" # full url (address/filename.extension)
